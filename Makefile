# This Makefile is for the App::Verm extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/App/Verm.pm]
...
#     NAME => q[App::Verm]
#     PL_FILES => {  }
#     PREREQ_PM => { Data::Dumper=>q[0], HTTP::Tiny=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/App/Verm.pm]
#     clean => { FILES=>q[App-verm-*] }
...
TO_INST_PM = lib/App/Verm.pm

PM_TO_BLIB = lib/App/Verm.pm \
	blib/lib/App/Verm.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN1EXT) --perm_rw=$(PERM_RW) -u \
	  verm $(INST_MAN1DIR)/verm.$(MAN1EXT) 
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) -u \
	  lib/App/Verm.pm $(INST_MAN3DIR)/App::Verm.$(MAN3EXT) 
...
$(INST_SCRIPT)/verm : verm $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/verm
	$(CP) verm $(INST_SCRIPT)/verm
	$(FIXIN) $(INST_SCRIPT)/verm
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/verm
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''get path to specific version of module'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: App-Verm' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "get path to specific version of module",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "App-Verm",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>get path to specific version of module</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Zdenek Bohunek &lt;zed448@icloud.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/App/Verm.pm blib/lib/App/Verm.pm 
